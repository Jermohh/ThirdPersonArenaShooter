...
void UCombatComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
    ...
    if (Character && Character->IsLocallyControlled())
    {
        ...
        else if (Character && Character->GetFollowCamera())
        {
            FVector TraceStart = Character->GetFollowCamera()->GetComponentLocation();
            FVector TraceEnd = TraceStart + Character->GetFollowCamera()->GetForwardVector() * TRACE_LENGTH;
            HitTarget = TraceEnd;
        }
...
void UCombatComponent::Fire()
{
    if (CanFire())
    {
        UE_LOG(LogTemp, Warning, TEXT("ISFIRINGinbCanFire"));
        bCanFire = false;
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("bCanFireIsnttickingtrue"));
    }
    UE_LOG(LogTemp, Warning, TEXT("Final HitTarget: %s"), *HitTarget.ToString());
}
...
void UCombatComponent::EquipWeapon(AWeapon* WeaponToEquip)
{
    ...
    Character->bWeaponEquipped = true;
}
...
void UCombatComponent::OnRep_EquippedWeapon()
{
    if (EquippedWeapon && Character)
    {
        ...
        // Make sure physics is OFF before attach
    ...
    if (Character && Character->IsLocallyControlled())
    {
        ABlasterPlayerController* BlasterPlayerController = Cast<ABlasterPlayerController>(Character->Controller);
